...
def _get_parser():
    ...
    parser.add_argument('--model', default='./checkpoints/model_best.pth.tar', type=str, metavar='PATH',
    ...
    parser.add_argument("--pruning-strategy", type=str, default='grad',
...
def prune_vgg(num_classes: int, sparse_model: torch.nn.Module, pruning_strategy: str, sanity_check: bool,
    ...
    pruned_model = copy.deepcopy(sparse_model)#1. copy.copy 浅拷贝 只拷贝父对象，不会拷贝对象的内部的子对象。2. copy.deepcopy 深拷贝 拷贝对象及其子对象
    pruned_model.cpu()
