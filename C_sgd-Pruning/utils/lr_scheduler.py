...
#   LR scheduler should work according the number of iterations，LR调度器应该根据迭代次数工作
def get_lr_scheduler(cfg, optimizer):
    it_ep = num_iters_per_epoch(cfg)#一次训练的最大读取次数(781)
    if cfg.linear_final_lr is None and cfg.cosine_minimum is None:
        lr_iter_boundaries = [it_ep * ep for ep in cfg.lr_epoch_boundaries]#lr_epoch_boundaries=[200, 400]
